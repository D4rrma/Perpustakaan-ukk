            ...
            <div class="p-5">
                ...
                <form method="post" class="user" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="judul" class="form-control" id="exampleInputEmail" placeholder="Judul">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tahun" class="form-control" id="exampleInputEmail" placeholder="Tahun">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="harga" class="form-control" id="exampleInputEmail" placeholder="Harga">
                    </div>
                    <div class="form-group">
